...
var instructions1 = {
  type: jsPsychHtmlButtonResponse,
  stimulus: `
    <p style="font-size:30px;"><b>GoStop Task</b></p>
...
var instructions2 = {
  type: jsPsychHtmlButtonResponse,
  stimulus: `
    <p style="font-size:35px;">When you see a number that is the same as the number presented right before it, press the blue button as quickly as possible.</p>
    <p style="font-size:35px;">However, some numbers will turn orange a short time after they appear. Do NOT press the blue button in this case.</p>
    <p style="font-size:35px;">Try to be as accurate as possible while still keeping up with the numbers. </p>
    <p style="font-size:35px;">Press the button below to begin.</p>
  `,
  button_html: '<button class="button" style="font-size: 24px; padding: 15px 30px;">%choice%</button>',
  choices: ['START'],
  post_trial_gap: 1000
